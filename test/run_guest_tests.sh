...
log "=== RVT2 Guest Validation ==="
log "Date: $(date)"
log "Kernel: $(uname -r)"
log ""

# AC-1: PCI device visible
log "[AC-1: PCI enumeration]"
...
# AC-2: Module load and sysfs
log ""
log "[AC-2: Module and sysfs]"
...
# AC-8: CXL HDM test
log ""
log "[AC-8: CXL HDM via driver]"
./rvt2_cxl_test 2>&1
check $? "CXL HDM BO via driver test passes"

# Summary
log ""
log "=== Guest Validation Summary ==="
log "Total: $((PASS + FAIL)) tests, $PASS passed, $FAIL failed"
log ""

# Save transcript
echo -e "$LOG" > /home/ubuntu/guest-validation-transcript.txt
echo "Transcript saved to /home/ubuntu/guest-validation-transcript.txt"
